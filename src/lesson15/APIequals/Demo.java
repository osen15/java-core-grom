...
public class Demo {
    public static void main(String[] args) {
       ...
       // Sys.out.println(Arrays.deepToString(bookingComAPI.findRooms(50, 2, "B", "B")));
      ...
      //  Sys.out.println(Arrays.deepToString(tripAdvisorAPI.findRooms(50, 2, "B", "B")));
        // Перевірка ціни (price) на допустиме значення (>0)
       // Sys.out.println(Arrays.deepToString(tripAdvisorAPI.findRooms(-50, 2, "B", "B")));
        // Перевірка персон (persons) на допустиме значення (>0)
       // Sys.out.println(Arrays.deepToString(tripAdvisorAPI.findRooms(-50, -2, "B", "B")));
      ...
      //  Sys.out.println(Arrays.deepToString(googleAPI.findRooms(50, 2, "B", "B")));
        // Перевірка ціни (price) на допустиме значення (>0)
      //  Sys.out.println(Arrays.deepToString(googleAPI.findRooms(-50, 2, "B", "B")));
        // Перевірка персон (persons) на допустиме значення (>0)
      //  Sys.out.println(Arrays.deepToString(googleAPI.findRooms(-50, -2, "B", "B")));
       ...
       // Sys.out.println(Arrays.deepToString(controller.requestRooms(50, 2, "B", "B")));
       ...
       // Sys.out.println(Arrays.deepToString(controller.check(null, bookingComAPI)));
        // Завантаження null - API api2
       // Sys.out.println(Arrays.deepToString(controller.check(googleAPI, null)));
        // Завантаження null - API api1 і API api2
       // Sys.out.println(Arrays.deepToString(controller.check(null, null)));
    }
